        ...
        <div class="px-4 mx-auto lg:py-8">
            <div class="px-4 mx-auto lg:py-8">
                <div class="flex justify-end">
                    <a href="{{ route('examfeepayments.index') }}" class="flex items-center">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 my-5">
                        ...
                        <div class="flex flex-wrap -mx-2">
                            <div class="w-full md:w-1/2 px-2">
                                ...
                                <input type="text" name="bank_name" id="bank_name"
                                    ...
                                    value="{{ old('bank_name', $examfeepayment->bank_name) }}">
                            </div>
                        ...
                        <div class="w-full">
                            ...
                            <input type="number" name="total_fee" id="total_fee"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Total Fee" value="{{ old('total_fee', $examfeepayment->total_fee) }}"
                                readonly>
                        </div>

                        <div class="w-full">
                            <label for="total"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Total(Ks)
                        ...
                        <div class="w-full">
                            <label for="refund"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Refund
                            </label>
