    ...
    <div class="px-4 py-4 sm:px-6 lg:px-8 bg-white shadow rounded-lg mb-5 mx-3">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-xl font-bold leading-6 text-gray-900">Sub Income/Expense List</h1>
            </div>
            <div class="mt-4 flex space-x-2 justify-end">
                ...
                <form action="{{ route('subincomeexpenses.index') }}" method="get" class="w-64 mx-auto">
                ...
                <a href="{{ route('subincomeexpenses.create') }}"
                            ...
                            @foreach ($subincomeexpenses as $subincomeexpense)
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm sm:pr-0 flex space-x-3">
                                        ...
                                        <form action="{{ route('subincomeexpenses.destroy', $subincomeexpense->id) }}"
                                            method="post">
                                            @csrf @method('delete')
