    ...
    <section class="bg-white w-full dark:bg-gray-900">
        <div class="px-4 mx-auto lg:py-8">
             <div class="flex justify-end">
                    <a href="{{ route('subincomeexpenses.index') }}" class="flex items-center">
            ...
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Edit Sub Income/Expense</h2>
            <form action="{{ route('subincomeexpenses.update', $subincomeexpense->id) }}" method="post">
                @csrf @method('put')
                <div class="w-full">
                    ...
                    <input type="text" name="name" id="name"
                        ...
                        placeholder="Enter Name" value="{{ old('name', $subincomeexpense->name) }}" required="">
                    @error('name')
